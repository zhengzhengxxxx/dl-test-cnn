...
INPUT_DATA = os.getcwd() +'/mingren'
OUTPUT_FILE = os.getcwd() + '/mingren_processed_data.npy'
...
def create_image_lists(sess,testing_percentage,validation_percentage):
    ...
    for sub_dir in sub_dirs:
        ...
        print(sub_dir)
        if (sub_dir != "G:\\dl\\code\\6/mingren\\zjl") and  (sub_dir != "G:\\dl\\code\\6/mingren\\ym") and (sub_dir != "G:\\dl\\code\\6/mingren\\gdg"):
            continue
