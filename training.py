...
now_dir = os.getcwd()
INPUT_DATA = now_dir + '/mingren_processed_data.npy'
TRAIN_FILE = now_dir + '/save_model'
CKPT_FILE = now_dir + '/inception_v3.ckpt'

LEARNING_RATE = 0.0001
STEPS = 300
BATCH = 4
N_CLASSES = 3
CHECKPOTIN_EXCLUDE_SCOPES = 'InceptionV3/Logits,InceptionV3/AuxLogits'
TRAINABLE_SCOPES='InceptionV3/Logits,InceptionV3/AuxLogits'

def get_tuned_variables():
    exclusions = [scope.strip() for scope in CHECKPOTIN_EXCLUDE_SCOPES.split(',')]
...
def main(self):
    ...
    with tf.Session() as sess:
        ...
        print('Final test accuyracy = %.1f%%' % (test_accuracy * 100))
